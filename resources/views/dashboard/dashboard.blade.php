        ...
        <div class="row">
            <div class="col-sm-7 monitor normal">
                <a href="/dashboard/create">
                    <button type="button" class="btn btn-default submit"><i class="fa fa-paper-plane" aria-hidden="true">
                        </i>+ Add</button></a>
                <br><br><br>
                    ...
                    <nav>
                        <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                            ...
                            <a class="nav-item nav-link active" id="nav-blok1-tab" data-toggle="tab" href="#nav-blok1"
                               role="tab" aria-controls="nav-blok1" aria-selected="true">{{$assignment->term}}</a>
                            @endforeach
                        </div>
                    </nav>
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="nav-blok1" role="tabpanel"
                            ...
                            <table class="table" cellspacing="0">
                                ...
                                @foreach($assignments as $assignment)
                                    <tr>
                                        <td><a href="/dashboard/{{ $assignment->id }}">{{$assignment->course}}</a></td>
